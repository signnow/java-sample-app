package com.signnow.samples.EmbeddedSenderWithFormDG;
...
public class IndexController implements ExampleInterface {
    ...
    // Demo URL constants
    private static final String REDIRECT_BASE_URL = "http://localhost:8080/samples/EmbeddedSenderWithFormDG";

    @Override
    public ResponseEntity<String> handleGet(Map<String, String> queryParams) throws IOException {
        // Demo: Simple HTML page serving
        String html = new String(Files.readAllBytes(Paths.get("src/main/resources/static/samples/EmbeddedSenderWithFormDG/index.html")));
